...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 04, 2016 at 06:12 PM
...
(1, -1, 'admin', '91739eb0a14999c738a8cea3691902d7', '', 'Phan Văn Liền', 'phanlien1093@gmail.com', 1451910069, 'cd61a580392a70389e27b0bc2b439f49');
...
(1277, 'san-pham', 'product', 'product', 'modules', 'product', 'vi', 1451910096, 1451910096),
(1278, 'san-pham1', 'product', 'product', 'modules', 'product', 'en', 1451910096, 1451910096);
...
(211, 'd7dba621eeae38d98c88dfb852a50ab4', '04/01/2016', 'localhost', 'localhost:8090', '', '', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/47.0.2526.106 Safari/537.36', 'Chrome', '::1', 'UnKnown', 1600, 900, 1451910052, 1451914990, 4938);
...
--
ALTER TABLE `friendly_link`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1279;
--
