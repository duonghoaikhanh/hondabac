		...
		menufunctions: function(){
			...
			if( $body.hasClass('device-lg') || $body.hasClass('device-md') ) {
				$('#primary-menu.sub-title > ul > li').hover(function() {
					...
					$(this).prev().css({ backgroundImage : 'url("menu-divider.png"/*tpa=http://bizweb.dktcdn.net/100/035/474/themes/46087/assets/images/icons/menu-divider.png*/)' });
				});
			...
			if( $flickrFeedEl.length > 0 ){
				$flickrFeedEl.each(function() {
					var element = $(this),
						...
						flickrFeedTypeGet = 'http://bizweb.dktcdn.net/100/035/474/themes/46087/assets/photos_public.gne';

					if( flickrFeedType == 'group' ) { flickrFeedTypeGet = 'http://bizweb.dktcdn.net/100/035/474/themes/46087/assets/groups_pool.gne'; }
