        ...
        <div class="col-lg-12">
            ...
            <div class="table_btn table_btn_top">
                ...
                <button type="button" class="btn btn-default"
                        onclick="do_submit_alert('do_duplicate', '{LANG.global.are_you_sure_duplicate}')"
                        value="{LANG.global.duplicate}" name="btnTrash">{LANG.global.duplicate}</button>
            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered table-hover table-striped table_row">
                    ...
                    <tr id="row_{row.item_id}">
                        ...
                        <td class="cot" align="center"><input class="checkbox" type="checkbox" value="{row.item_id}"
                                                              name="selected_id[]"></td>

                        <td class="cot" align="center">{row.item_id}</td>

                        <td class="cot" align="center"><input type="text" value="{row.show_order}"
                                                              name="show_order[{row.item_id}]" size="4"
                                                              style="text-align:center;"
                                                              onchange="do_check ({row.item_id})"></td>
