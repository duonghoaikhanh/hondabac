...
<div class="row">
    ...
    <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{data.link_manage_trash}" {data.class.manage_trash}><i
                            class="fa fa-trash-o"></i> {LANG.global.trash}</a></li>
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            ...
            <div class="form-group">
                ...
                <input name="title" id="title" type="text" size="50" maxlength="150" value="{data.title}"
                       class="form-control">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            ...
            <div class="form-group">
                ...
                <input name="friendly_link" id="friendly_link" type="text" size="50" maxlength="150"
                       value="{data.friendly_link}" class="form-control">
        ...
        <div class="col-lg-6">
            ...
            <div class="form-group">
                ...
                <input name="meta_title" id="meta_title" type="text" size="50" maxlength="150" value="{data.meta_title}"
                       class="form-control">
        ...
        <div class="box_search">
            ...
            <form action="{data.link_action_search}" method="post" name="form_search" id="form_search">
                ...
                <div class="row_search">
                    ...
                    <div class="col_search"><label>{LANG.global.date_begin}:</label> <input name="search_date_begin"
                                                                                            type="text" size="20"
                                                                                            maxlength="150"
                                                                                            value="{data.search_date_begin}"
                                                                                            class="form-control datepicker">
                    </div>

                    <div class="col_search"><label>{LANG.global.date_end}:</label> <input name="search_date_end"
                                                                                          type="text" size="20"
                                                                                          maxlength="150"
                                                                                          value="{data.search_date_end}"
                                                                                          class="form-control datepicker">
                    </div>
                    ...
                    <div class="col_search"><label>{LANG.global.text_search}:</label>
                        ...
                        <div class="form-group input-group">
                            ...
                            <input name="search_title" type="text" size="20" maxlength="150" value="{data.search_title}"
                                   class="form-control">
        ...
        <div class="col-lg-12">
            ...
            <div class="table_btn table_btn_top">
                ...
                <button type="button" class="btn btn-default"
                        onclick="do_submit_alert('do_trash', '{LANG.global.are_you_sure_trash}')"
                        value="{LANG.global.btn_trash}" name="btnTrash">{LANG.global.btn_trash}</button>
                ...
                <button type="button" class="btn btn-default"
                        onclick="do_submit_alert('do_restore', '{LANG.global.are_you_sure_restore}')"
                        value="{LANG.global.btn_restore}" name="btnRestore">{LANG.global.btn_restore}</button>

                <button type="button" class="btn btn-default"
                        onclick="do_submit_alert('do_del', '{LANG.global.are_you_sure_del}')"
                        value="{LANG.global.btn_del}" name="btnDel">{LANG.global.btn_del}</button>
            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered table-hover table-striped table_row">
                    ...
                    <tr>
                        ...
                        <th class="header" width="3%"><input id="checkall" class="checkbox" type="checkbox"
                                                             name="checkall" value="all"/></th>
                    ...
                    <tr id="row_{row.group_id}">
                        ...
                        <td class="cot" align="center"><input class="checkbox" type="checkbox" value="{row.group_id}"
                                                              name="selected_id[]"/></td>

                        <td class="cot" align="center">{row.group_id}</td>

                        <td class="cot">{row.pre_title}<input type="text" value="{row.show_order}"
                                                              name="show_order[{row.group_id}]" size="4"
                                                              style="text-align:center;"
                                                              onchange="do_check ({row.group_id})"/></td>
                        ...
                        <td class="cot" align="center">
                            ...
                            <input class="checkbox" type="checkbox" value="1"
                                   name="is_focus[{row.group_id}]" {row.is_focus_checked}
                                   onchange="do_check ('{row.group_id}')"/>
                        ...
                        <td class="cot" align="center">
                            ...
                            <input class="checkbox" type="checkbox" value="1"
                                   name="is_show_menu[{row.group_id}]" {row.is_show_menu_checked}
                                   onchange="do_check ('{row.group_id}')"/>
                        ...
                        <td class="cot" align="center">
                            ...
                            <a href="{row.link_edit}"><img src="{DIR_IMAGE}icon_edit.png" atl="{LANG.global.edit}"
                                                           title="{LANG.global.edit}"/></a>

                            <!-- BEGIN: row_button_trash -->

                            <a href="javascript:action_item('{row.link_trash}','{LANG.global.are_you_sure_trash}')"><img
                                        src="{DIR_IMAGE}icon_trash.png" atl="{LANG.global.trash}"
                                        title="{LANG.global.trash}"/></a>
                            ...
                            <a href="javascript:action_item('{row.link_restore}','{LANG.global.are_you_sure_restore}')"><img
                                        src="{DIR_IMAGE}icon_restore.png" atl="{LANG.global.restore}"
                                        title="{LANG.global.restore}"/></a>

                            <a href="javascript:action_item('{row.link_del}','{LANG.global.are_you_sure_del}')"><img
                                        src="{DIR_IMAGE}icon_del.png" atl="{LANG.global.del}"
                                        title="{LANG.global.del}"/></a>
                    ...
                    <tr>
                        ...
                        <td class="cot" align="center">{row.pre_title}<input type="text" value="{row.show_order}"
                                                                             name="show_order[{row.group_id}]" size="4"
                                                                             style="text-align:center;"
                                                                             onchange="do_check ({row.group_id})"></td>
