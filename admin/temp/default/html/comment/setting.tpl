...
<div class="row">
    ...
    <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
            <li><a href="{data.link_manage}" {data.class.manage}><i class="fa fa-wrench"></i> {LANG.global.config}</a>
            </li>
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            ...
            <div class="form-group">
                ...
                <input name="page_meta_title" id="page_meta_title" type="text" size="50" maxlength="150"
                       value="{data.page_meta_title}" class="form-control">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            ...
            <div class="form-group">
                ...
                <textarea name="page_meta_key" id="page_meta_key" class="form-control"
                          rows="1">{data.page_meta_key}</textarea>
        ...
        <div class="col-lg-6">
            ...
            <div class="form-group">
                ...
                <textarea name="page_meta_desc" id="page_meta_desc" class="form-control"
                          rows="1">{data.page_meta_desc}</textarea>
